...
## [Unreleased]
## [0.0.9](https://github.com/ormeilu/rolter/compare/rolter-control-v0.0.8...rolter-control-v0.0.9) - 2026-07-15
...
- *(control)* add per-invocation log viewer to Logs page ([#189](https://github.com/ormeilu/rolter/pull/189)) by [@ormeilu](https://github.com/ormeilu)
